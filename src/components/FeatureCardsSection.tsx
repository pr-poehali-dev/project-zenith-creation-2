...
const featureCards = [
  {
    title: "Высокая теплотворная способность",
    illustration: (
  ...
  {
    title: "Стабильный фракционный состав",
    illustration: (
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <img
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-16">
            ...
            >
              Премиум качество для промышленности
            </motion.h2>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <p className="text-zinc-400 leading-relaxed">
                Наш кокс отвечает строжайшим стандартам металлургической отрасли:
                высокая прочность, минимальные примеси и гарантированное качество.{" "}
